...
return [
    ...
    /* ---- Produits cafétéria ---- */
    'Red Bull' => ['en' => 'Red Bull', 'de' => 'Red Bull', 'es' => 'Red Bull', 'zh' => '红牛', 'ja' => 'レッドブル', 'pl' => 'Red Bull', 'ru' => 'Red Bull', 'ms' => 'Red Bull'],
    'Kinder Bueno' => ['en' => 'Kinder Bueno', 'de' => 'Kinder Bueno', 'es' => 'Kinder Bueno', 'zh' => '健达缤纷乐', 'ja' => 'キンダーブエノ', 'pl' => 'Kinder Bueno', 'ru' => 'Kinder Bueno', 'ms' => 'Kinder Bueno'],
    'Eau' => ['en' => 'Water', 'de' => 'Wasser', 'es' => 'Agua', 'zh' => '水', 'ja' => '水', 'pl' => 'Woda', 'ru' => 'Вода', 'ms' => 'Air'],
    'Monster' => ['en' => 'Monster', 'de' => 'Monster', 'es' => 'Monster', 'zh' => '魔爪', 'ja' => 'モンスター', 'pl' => 'Monster', 'ru' => 'Monster', 'ms' => 'Monster'],
    'Coca-Cola' => ['en' => 'Coca-Cola', 'de' => 'Coca-Cola', 'es' => 'Coca-Cola', 'zh' => '可口可乐', 'ja' => 'コカ・コーラ', 'pl' => 'Coca-Cola', 'ru' => 'Coca-Cola', 'ms' => 'Coca-Cola'],
    'Oasis' => ['en' => 'Oasis', 'de' => 'Oasis', 'es' => 'Oasis', 'zh' => '绿洲', 'ja' => 'オアシス', 'pl' => 'Oasis', 'ru' => 'Oasis', 'ms' => 'Oasis'],
    'Fanta' => ['en' => 'Fanta', 'de' => 'Fanta', 'es' => 'Fanta', 'zh' => '芬达', 'ja' => 'ファンタ', 'pl' => 'Fanta', 'ru' => 'Fanta', 'ms' => 'Fanta'],
    'Minute Maid' => ['en' => 'Minute Maid', 'de' => 'Minute Maid', 'es' => 'Minute Maid', 'zh' => '美汁源', 'ja' => 'ミニッツメイド', 'pl' => 'Minute Maid', 'ru' => 'Minute Maid', 'ms' => 'Minute Maid'],
    'Lipton' => ['en' => 'Lipton', 'de' => 'Lipton', 'es' => 'Lipton', 'zh' => '立顿', 'ja' => 'リプトン', 'pl' => 'Lipton', 'ru' => 'Lipton', 'ms' => 'Lipton'],
    'Orangina' => ['en' => 'Orangina', 'de' => 'Orangina', 'es' => 'Orangina', 'zh' => '新奇士', 'ja' => 'オランジーナ', 'pl' => 'Orangina', 'ru' => 'Orangina', 'ms' => 'Orangina'],
    'Dr Pepper' => ['en' => 'Dr Pepper', 'de' => 'Dr Pepper', 'es' => 'Dr Pepper', 'zh' => '胡椒博士', 'ja' => 'ドクターペッパー', 'pl' => 'Dr Pepper', 'ru' => 'Dr Pepper', 'ms' => 'Dr Pepper'],
    'Cristaline' => ['en' => 'Cristaline', 'de' => 'Cristaline', 'es' => 'Cristaline', 'zh' => '克里斯塔琳', 'ja' => 'クリスタリン', 'pl' => 'Cristaline', 'ru' => 'Cristaline', 'ms' => 'Cristaline'],
    'Perrier' => ['en' => 'Perrier', 'de' => 'Perrier', 'es' => 'Perrier', 'zh' => '巴黎水', 'ja' => 'ペリエ', 'pl' => 'Perrier', 'ru' => 'Perrier', 'ms' => 'Perrier'],
    'Schweppes' => ['en' => 'Schweppes', 'de' => 'Schweppes', 'es' => 'Schweppes', 'zh' => '怡泉', 'ja' => 'シュウェップス', 'pl' => 'Schweppes', 'ru' => 'Schweppes', 'ms' => 'Schweppes'],
    ...
    'Chips' => ['en' => 'Chips', 'de' => 'Chips', 'es' => 'Patatas fritas', 'zh' => '薯片', 'ja' => 'ポテトチップス', 'pl' => 'Chipsy', 'ru' => 'Чипсы', 'ms' => 'Kerepek'],
    'Lion' => ['en' => 'Lion', 'de' => 'Lion', 'es' => 'Lion', 'zh' => '雄狮', 'ja' => 'ライオン', 'pl' => 'Lion', 'ru' => 'Lion', 'ms' => 'Lion'],
    'Mister Freeze' => ['en' => 'Ice pop', 'de' => 'Eis am Stiel', 'es' => 'Polo helado', 'zh' => '冰棒', 'ja' => 'アイスポップ', 'pl' => 'Lody na patyku', 'ru' => 'Лёд на палочке', 'ms' => 'Ais pop'],

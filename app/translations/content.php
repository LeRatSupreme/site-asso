...
return [
    ...
    "Gère les finances, les paiements, la comptabilité et le réapprovisionnement de la cafétéria." => ['en' => 'Manages finances, payments, accounting and cafeteria restocking.', 'de' => 'Verwaltet Finanzen, Zahlungen, Buchhaltung und Cafeteria-Nachbestellung.', 'es' => 'Gestiona finanzas, pagos, contabilidad y reposición de cafetería.', 'zh' => '管理财务、付款、会计和咖啡厅补货。', 'ja' => '財務、支払い、会計、カフェテリアの補充を管理します。', 'pl' => 'Zarządza finansami, płatnościami, księgowością i uzupełnianiem kafeterii.', 'ru' => 'Управляет финансами, платежами, бухгалтерией и пополнением кафетерия.', 'ms' => 'Mengurus kewangan, pembayaran, perakaunan dan tambahan stok kafeteria.'],

...
CREATE TABLE IF NOT EXISTS users (
    ...
    role        ENUM('ADMIN','TRESORERIE','EVENEMENTS','COMMUNICATION','CAFETERIA','JEUX','ELEVE') NOT NULL DEFAULT 'ELEVE',
...
-- -------------------------------------------------------------------
--  Suivi comptable avancé : dépenses, achats, inventaires, budgets
-- -------------------------------------------------------------------
...
-- Journal des pertes : casse, vol, périmé, offert (déduit du stock théorique)
...
-- Événements de trésorerie (le nom = libellé exact du bouton SumUp)
...
-- Coûts attachés à un événement (chaque coût crée une dépense liée EVENEMENT)

...
<h1 style="margin:0 0 0.5rem;font-size:1.3rem;color:#48bdd3;">🎟️ Une place s'est libérée !</h1>
<p style="font-size:1rem;line-height:1.6;">Bonjour <strong><?= e($prenom) ?></strong>,</p>
<p style="font-size:1rem;line-height:1.6;">
Vous étiez sur liste d'attente : bonne nouvelle, vous êtes désormais <strong>inscrit·e</strong> à l'événement :
</p>
...
<p style="margin:0;font-size:1.1rem;font-weight:700;color:#48bdd3;"><?= e($eventTitle) ?></p>
</div>

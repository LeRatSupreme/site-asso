    ...
    <tr><td align="center">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;background:#fff;border-radius:14px;overflow:hidden;">
        ...
        <tr><td style="padding:32px;">
          ...
          <p style="margin:0 0 16px;line-height:1.6;">Ton compte a bien été créé. Bienvenue dans l'<?= e($siteName) ?> — l'association étudiante en informatique de Calais.</p>
          <p style="margin:0 0 24px;line-height:1.6;">Tu peux désormais t'inscrire aux événements et commander à la cafétéria.</p>
          <p style="margin:0;">
            <a href="<?= e($siteUrl) ?>/eleve" style="display:inline-block;background:#c8102e;color:#fff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:700;">Accéder à mon espace</a>
          </p>
        </td></tr>

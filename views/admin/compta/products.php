...
<div class="card surface glass table-wrap">
    <table class="table">
        <thead><tr><th>Produit</th><th>Catégorie</th><th>Qté</th><th>Prix moy.</th><th>CA</th><th>Coût unit.</th><th>Bénéfice</th><th>Marge</th></tr></thead>
        <tbody>
            <?php foreach ($rows as $r): ?>
                ...
                <tr>
                    ...
                    <td><?= e(formatPrice($r['avg_price'] ?? 0)) ?></td>
